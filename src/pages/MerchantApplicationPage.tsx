...
const MerchantApplicationPage: React.FC = () => {
  ...
  const steps = [
    ...
    { number: 3, title: 'Booth Selection' },
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  rows={6}
                  className="input-field"
                  placeholder="Describe your products, unique selling points, target customers..."
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { value: 'basic', name: 'Basic', price: '₦50,000', space: '2m x 2m' },
                  { value: 'standard', name: 'Standard', price: '₦100,000', space: '3m x 3m' },
                  { value: 'premium', name: 'Premium', price: '₦200,000', space: '4m x 4m' },
                ].map((pkg) => (
                  <label key={pkg.value} className="cursor-pointer">
                    <input
                      ...
                      name="booth"
                      value={pkg.value}
                      checked={formData.boothPackage === pkg.value}
                      onChange={(e) => setFormData({ ...formData, boothPackage: e.target.value as any })}
                      className="sr-only"
                    />
                    <div
                      className={`card p-6 text-center transition-all ${
                        formData.boothPackage === pkg.value

...
const DashboardPage: React.FC = () => {
  ...
  const stats = [
    { icon: Package, label: 'Applications', value: applications.length, color: 'from-blue-500 to-blue-700' },
    { icon: Store, label: 'Active Booths', value: applications.filter(a => a.status === 'approved').length, color: 'from-green-500 to-green-700' },
    { icon: Calendar, label: 'Upcoming Events', value: '1', color: 'from-purple-500 to-purple-700' },
    { icon: TrendingUp, label: 'Total Reach', value: '15K+', color: 'from-orange-500 to-orange-700' },
  ];

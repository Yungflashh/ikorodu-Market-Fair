...
const SponsorsPage: React.FC = () => {
  ...
  const sponsorshipTiers: SponsorshipTier[] = [
    ...
    },
    {
      ...
      benefits: [
        ...
        'Digital marketplace co-branding',
        'Investor pitch session hosting',
        '20 VIP passes',
  ...
  const pastSponsors = [
    { name: 'Company A', logo: 'https://via.placeholder.com/150x60?text=Company+A' },
    { name: 'Company B', logo: 'https://via.placeholder.com/150x60?text=Company+B' },
    { name: 'Company C', logo: 'https://via.placeholder.com/150x60?text=Company+C' },
    { name: 'Company D', logo: 'https://via.placeholder.com/150x60?text=Company+D' },
  ];
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {pastSponsors.map((sponsor, index) => (
              <div
                key={index}
                className="flex items-center justify-center p-6 bg-white rounded-lg grayscale hover:grayscale-0 transition-all"
              >

...
const RegisterPage: React.FC = () => {
  ...
  const roles = [
    { value: 'customer', label: 'Customer', description: 'Shop at the event' },
    { value: 'merchant', label: 'Merchant', description: 'Sell your products' },
    { value: 'sponsor', label: 'Sponsor', description: 'Partner with us' },
  ];

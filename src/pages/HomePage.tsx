...
const HomePage: React.FC = () => {
  ...
  const heroStats = [
    { icon: Users, value: '200+', label: 'MSMEs Exhibiting' },
    { icon: ShoppingBag, value: '10,000+', label: 'Expected Visitors' },
    { icon: TrendingDown, value: 'Up to 50%', label: 'Price Crashes' },
    { icon: Calendar, value: '6 Days', label: 'of Opportunities' },
  ];
  ...
  const opportunities = [
    {
      ...
      benefits: [
        'Save 30-50% on everyday items',
        'Access 200+ vendors in one place',
        'Find products not available in regular stores',
        'Get freebies and promotional gifts',
        'Win prizes through lucky draws',
        'Enjoy entertainment while shopping',
      ],
      cta: 'Start Shopping',
      link: '/customers',
    },
    {
      ...
      benefits: [
        'Reach 10,000+ potential customers',
        'Network with other business owners',
        'Access free CAC registration support',
        'Meet investors and secure funding',
        'Get business mentorship from experts',
        'Continue selling online after event',
      ],
    ...
    },
    {
      ...
      benefits: [
        'Reach 10,000+ engaged audience',
        'Demonstrate corporate social responsibility',
        'Build brand awareness in Ikorodu',
        'Support local economic development',
        'Access to extensive media coverage',
        'Partnership with growing community',
      ],
  ...
  const impactStats = [
    { number: '500+', label: 'MSMEs Empowered Since 2022', icon: Store },
    { number: '₦50M+', label: 'Total Sales Generated', icon: DollarSign },
    { number: '25,000+', label: 'Satisfied Customers', icon: Users },
    { number: '95%', label: 'Merchant Satisfaction Rate', icon: Star },
  ];
  ...
  const partners = [
    'Talent Plus Resources International',
    'Lagos State MSME Office',
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-green-700 via-green-800 to-green-900 text-white section-padding overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 leading-relaxed text-green-100">
        ...
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="heading-2 mb-4">
              Why Do Prices <span className="text-green-600">Crash</span> at IMF?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyPricesCrash.map((reason, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}

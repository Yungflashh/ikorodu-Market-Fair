...
const ContactPage: React.FC = () => {
  ...
  const contactInfo = [
    { icon: Phone, title: 'Phone', value: '+234 XXX XXX XXXX', link: 'tel:+234XXXXXXXXX' },
    { icon: Mail, title: 'Email', value: 'info@ikorodumarketfair.com', link: 'mailto:info@ikorodumarketfair.com' },
    { icon: MapPin, title: 'Address', value: 'Ikorodu Town Hall, Lagos State, Nigeria', link: '#' },
    { icon: Clock, title: 'Office Hours', value: 'Mon-Fri: 9AM-5PM', link: '#' },
  ];

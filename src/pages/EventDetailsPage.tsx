...
const EventDetailsPage: React.FC = () => {
  ...
  const dailySchedule = [
    {
      ...
      activities: [
        { time: '8:00 AM', title: 'Gates Open', description: 'Early bird entry for pre-registered guests', icon: Clock },
        { time: '9:00 AM', title: 'Opening Ceremony', description: 'Welcome address by organizers and special guests', icon: Users },
        { time: '10:00 AM', title: 'Shopping Begins', description: 'All 200+ booths officially open for business', icon: Gift },
        { time: '11:00 AM', title: 'Business Registration Desk Opens', description: 'On-site CAC registration support', icon: CheckCircle2 },
        { time: '12:00 PM', title: 'Fashion Show', description: 'Local designers showcase latest collections', icon: Users },
        { time: '1:00 PM', title: 'Lunch Break', description: 'Food court featuring local delicacies', icon: Utensils },
        { time: '2:00 PM', title: 'Live Music Performance', description: 'Local artists and bands', icon: Music },
        { time: '3:00 PM', title: 'Investor Pitch Session', description: 'Selected merchants pitch to investors', icon: Trophy },
        { time: '4:00 PM', title: 'First Lucky Draw', description: 'Win amazing prizes!', icon: Gift },
        { time: '5:00 PM', title: 'Kids Zone Activities', description: 'Face painting, games, and entertainment', icon: Heart },
        { time: '6:00 PM', title: 'Day 1 Closing', description: 'See you tomorrow!', icon: Clock },
      ],
    },
    {
      day: 'Day 2',
      ...
      activities: [
        { time: '9:00 AM', title: 'Early Bird Shopping', description: 'Special morning deals', icon: Gift },
        { time: '10:00 AM', title: 'Cooking Demonstration', description: 'Celebrity chefs showcase recipes', icon: Utensils },
        { time: '11:00 AM', title: 'Kids Zone Opens', description: 'Bouncy castles, face painting, games', icon: BabyIcon },
        { time: '12:00 PM', title: 'Food Tasting Tour', description: 'Sample dishes from various vendors', icon: Utensils },
        { time: '1:00 PM', title: 'Family Photo Contest', description: 'Win prizes for best family photos', icon: Camera },
        { time: '2:00 PM', title: 'MSME Workshop', description: 'Business growth strategies', icon: Users },
        { time: '3:00 PM', title: 'Cultural Dance Performance', description: 'Traditional Nigerian dances', icon: Music },
        { time: '4:00 PM', title: 'Product Sampling', description: 'Free samples from exhibitors', icon: Gift },
        { time: '5:00 PM', title: 'Mega Lucky Draw', description: 'Grand prizes worth millions!', icon: Trophy },
        { time: '6:00 PM', title: 'Evening Entertainment', description: 'Live band performance', icon: Music },
        { time: '7:00 PM', title: 'Day 2 Closing', description: 'Final day tomorrow!', icon: Clock },
      ],
    },
    {
      day: 'Day 3',
      ...
      activities: [
        { time: '9:00 AM', title: 'Final Day Deals', description: 'Massive discounts up to 50%', icon: Gift },
        { time: '10:00 AM', title: 'Meet the Makers Session', description: 'Chat with business owners', icon: Users },
        { time: '11:00 AM', title: 'Panel Discussion', description: 'Future of MSMEs in Nigeria', icon: Users },
        { time: '12:00 PM', title: 'Charity Auction', description: 'Bid on exclusive items for charity', icon: Heart },
        { time: '1:00 PM', title: 'Family Games', description: 'Fun activities for all ages', icon: Trophy },
        { time: '2:00 PM', title: 'Last Chance Shopping', description: 'Final opportunity for deals', icon: Gift },
        { time: '3:00 PM', title: 'Grand Finale Show', description: 'Special performances and entertainment', icon: Music },
        { time: '4:00 PM', title: 'Awards Ceremony', description: 'Best exhibitor, best customer, etc.', icon: Trophy },
        { time: '5:00 PM', title: 'Final Lucky Draw', description: 'Last chance to win!', icon: Gift },
        { time: '5:45 PM', title: 'Closing Ceremony', description: 'Thank you and see you next year!', icon: Users },
        { time: '6:00 PM', title: 'Event Ends', description: 'Safe journey home!', icon: Clock },
      ],
    },
  ];
  ...
  const facilities = [
    { icon: Wifi, title: 'Free WiFi', description: 'Throughout venue' },
    { icon: Car, title: 'Free Parking', description: '500+ spaces' },
    { icon: Accessibility, title: 'Wheelchair Access', description: 'Fully accessible' },
    { icon: Shield, title: 'Security', description: '24/7 on-site' },
    { icon: Utensils, title: 'Food & Drinks', description: 'Multiple options' },
    { icon: Camera, title: 'Photo Booths', description: 'Free photos' },
    { icon: BabyIcon, title: 'Nursing Room', description: 'Private space' },
    { icon: AlertCircle, title: 'First Aid', description: 'Medical team' },
  ];
  ...
  const rules = [
    ...
    'Photography allowed (no flash near stage)',
    'Respect all vendors and visitors',
    'Follow COVID-19 protocols if active',
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              {dailySchedule[activeDay].activities.map((activity, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
      ...
      <section className="section-padding bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.952912260219!2d3.395270315744!3d6.451512795363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8b2ae68280c1%3A0xdc9e87a367c3d!2sLagos!5e0!3m2!1sen!2sng!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen

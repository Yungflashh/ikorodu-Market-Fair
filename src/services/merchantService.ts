...
export const merchantService = {
  ...
  getAllApplications: async (page = 1, limit = 10, status?: string): Promise<ApiResponse<MerchantApplication[]>> => {
  ...
  updateApplicationStatus: async (id: string, status: string, boothNumber?: string): Promise<ApiResponse<MerchantApplication>> => {
